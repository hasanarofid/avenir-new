...
const submit = () => {
  if (isEdit) {
    form.post(route('mitra.researches.update', props.research.id), {
      forceFormData: true,
      preserveScroll: true
    });
  } else {
    form.post(route('mitra.researches.store'), {
      forceFormData: true
    });
  }
};
  ...
  <MitraLayout>
    <div class="space-y-8 pb-12">
      ...
      <div class="flex items-center gap-4">
        <Link :href="route('mitra.researches.index')" class="p-2 bg-[#121614] border border-emerald-950/25 hover:bg-[#090b0a] rounded-xl text-slate-400 hover:text-slate-200 transition-colors">
