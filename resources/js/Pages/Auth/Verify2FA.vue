...
const submit = () => {
    form.post(route('2fa.confirm-verify'), {
...
<template>
    <GuestLayout>
        ...
        <div class="mb-8">
            <Link :href="route('password.request')" class="inline-flex items-center text-xs font-semibold text-slate-400 hover:text-emerald-400 transition-colors mb-6 group">
