...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/hasan/Documents/hasanarofid/avenir/default-avenir/public/storage' => 'string',
            ...
            'services.openrouter.api_key' => 'string',
            'services.openrouter.default_model' => 'string',
            'services.openrouter.fallback_model' => 'string',
...
'cors.allowed_headers','cors.exposed_headers','cors.max_age','cors.supports_credentials','view.paths',
'view.compiled','hashing.driver','hashing.bcrypt.rounds','hashing.bcrypt.verify','hashing.bcrypt.limit',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/hasan/Documents/hasanarofid/avenir/default-avenir/public/storage','logging.default','logging.deprecations.channel',
...
'mail.markdown.extensions','permission.models.permission','permission.models.role','permission.models.team','permission.models.default_model',
...
'services.openrouter.api_key','services.openrouter.default_model','services.openrouter.fallback_model','session.driver','session.lifetime',
...
'inertia.history.encrypt','sanctum.stateful','sanctum.guard','sanctum.expiration','sanctum.token_prefix',
...
'signed','throttle','verified','premium',);
        registerArgumentsSet('routes', 
'sanctum.csrf-cookie','home','katalog','katalog.detail',
'artikel','artikel.detail','news','news.detail','emiten.index',
'emiten.show','ki-brief.index','disclosure.index','watchlist.index','watchlist.toggle',
'tentang','mitra','langganan','langganan.kirim','password.migrate.setup','password.migrate.store','dashboard','profile.edit',
'profile.update','profile.destroy','mitra.register','mitra.register.store','mitra.dashboard',
'mitra.researches','mitra.profile','admin.dashboard','admin.ai-logs.index','admin.payments.index',
'admin.mitra.index','admin.mitra.approve','admin.mitra.update','admin.mitra.destroy','admin.users.index',
'admin.notifications.index','admin.notifications.store','admin.notifications.update','admin.notifications.destroy','admin.settings.index',
'admin.settings.update','admin.pages.index','admin.pages.create','admin.pages.store','admin.pages.show',
'admin.pages.edit','admin.pages.update','admin.pages.destroy','admin.pages.sections.update','admin.posts.index',
'admin.posts.create','admin.posts.store','admin.posts.show','admin.posts.edit','admin.posts.update',
'admin.posts.destroy','admin.categories.store','admin.categories.destroy','admin.research-generator.index','admin.research-generator.create',
'admin.research-generator.store','admin.research-generator.show','admin.research-generator.generate','admin.research-generator.publish','admin.news-generator.index',
'admin.news-generator.generate','admin.news-generator.publish','register','login','password.request',
...
'AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','OPENROUTER_API_KEY','OPENROUTER_DEFAULT_MODEL',
