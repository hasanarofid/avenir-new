                ...
                <div class="featured-content">
                  ...
                  <div class="article-meta-bottom">
                    ...
                    <div class="flex items-center gap-4 ml-auto">
                      <span class="flex items-center gap-1.5 hover:text-rose-400 transition-colors">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>
                        {{ featuredArticle.likes_count || 0 }}
                      </span>
                      ...
                      <span class="flex items-center gap-1.5 hover:text-emerald-400 transition-colors">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><line x1="8.59" y1="13.51" x2="15.42" y2="17.49"/><line x1="15.41" y1="6.51" x2="8.59" y2="10.49"/></svg>
                        {{ featuredArticle.shares_count || 0 }}
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div class="recent-content">
                  ...
                  <div class="article-meta-bottom small mt-auto">
                    ...
                    <div class="flex items-center gap-3 ml-auto">
                      <span class="flex items-center gap-1 hover:text-rose-400 transition-colors">
                      ...
                      <span class="flex items-center gap-1 hover:text-emerald-400 transition-colors">
