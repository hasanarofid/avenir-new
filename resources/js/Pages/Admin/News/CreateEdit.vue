...
const form = useForm({
  ...
  category: props.news?.category || 'Market',
  ...
  <AdminLayout>
    <div class="space-y-8 pb-12">
      ...
      <div class="flex items-center gap-4">
        <Link :href="route('admin.news.index')" class="p-2 bg-[#121614] border border-emerald-950/25 hover:bg-[#090b0a] rounded-xl text-slate-400 hover:text-slate-200 transition-colors">
        ...
        <div class="p-6 md:p-8 space-y-6">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-1 md:col-span-2">
              <label for="title" class="text-xs font-bold text-slate-400 uppercase tracking-wider">Judul Berita</label>
              <input 
                id="title"
                v-model="form.title"
                type="text" 
            ...
            <div class="space-y-1">
              <label for="sentiment" class="text-xs font-bold text-slate-400 uppercase tracking-wider">Sentimen</label>
              <select 
                id="sentiment"
            ...
            <!-- Source & URL -->
            <div class="space-y-1">
              <label for="source" class="text-xs font-bold text-slate-400 uppercase tracking-wider">Sumber Berita</label>
              <input 
                id="source"
                v-model="form.source"
                type="text" 
            ...
            <div class="space-y-1">
              <label for="source_url" class="text-xs font-bold text-slate-400 uppercase tracking-wider">URL Sumber Lengkap</label>
              <input 
                id="source_url"
            ...
            <!-- Date & Status -->
            <div class="space-y-1">
              <label for="published_at" class="text-xs font-bold text-slate-400 uppercase tracking-wider">Tanggal Publikasi</label>
              <input 
                id="published_at"
            ...
            <!-- File paths -->
            <div class="space-y-1 md:col-span-2">
              <label for="image" class="text-xs font-bold text-slate-400 uppercase tracking-wider">Cover Image Berita</label>
              <div 
