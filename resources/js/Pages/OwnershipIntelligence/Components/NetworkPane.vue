  ...
  <div>
    <div class="layout">
      <div>
        <div class="panelHead">
          ...
          <div><span class="muted small" id="netMeta"></span> <button class="btn" id="fitBtn" style="margin-left:8px">Re-center</button></div>
        </div>
        <div class="networkWrap">
          ...
          <div class="netctrls">
            <div class="netbtn" id="netZoomIn">+</div>
            <div class="netbtn" id="netZoomOut">−</div>
            <div class="netbtn" id="netFit" title="Fit ke tengah">⤢</div>
          </div>
          <div class="netlegend">
    ...
    <div class="twoCols" style="padding:16px 18px 18px">
      <div class="panel" style="box-shadow:none">
        <div class="panelHead"><h3>Owners of selected issuer</h3><span class="muted small" id="ownersMeta"></span></div>
        <div class="tableWrap"><table class="tbl" id="ownersTable"></table></div>
      </div>
      <div class="panel" style="box-shadow:none">
        <div class="panelHead"><h3>Holdings by selected entity</h3><span class="muted small" id="holdingsMeta"></span></div>
        <div class="tableWrap"><table class="tbl" id="holdingsTable"></table></div>
      </div>
    </div>
  </div>
</template>
