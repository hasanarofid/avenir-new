...
// Call vanilla's switchTab — handles visibility + renders the pane
  ...
  <AppLayout>
    ...
    <div v-else class="app">
      ...
      <main class="main">
        ...
        <!-- Mode Toggle — data-mode used by vanilla switchMode -->
        ...
        <!-- SelectorPanel & KpiGrid — vanilla controls visibility via style.display -->
        <SelectorPanel />
        <KpiGrid />

        <section class="panel">
          <!-- Tabbar — all tabs always in DOM, data-tab/data-mode used by vanilla -->
          <div class="tabbar">
            <!-- Detail mode tabs -->
            ...
            <!-- Global mode tabs — hidden by vanilla switchMode initially -->
          ...
          <!-- Tab Panes — id must match tab name, vanilla toggles .on class -->
